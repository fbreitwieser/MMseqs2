...
#include "Debug.h"
#include "Util.h"
#include "download.sh.h"

int download(int argc, const char **argv, const Command& command) {
    ...
    FileUtil::writeFile(tmp + "/download.sh", download_sh, download_sh_len);
    std::string program(tmp + "/download.sh");
